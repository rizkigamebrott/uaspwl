...
<html lang="en">
  ...
  <body>
      ...
      <div class="row">
        ...
        <a href="tambahcompany.php" class="btn btn-success">Add Data</a> &nbsp   
        </div>
        <div class="col-6">
              ...
              <?php 
                ...
                $exQuery = $mysqli->query($query);
                   while($user_data = mysqli_fetch_array($exQuery)) {         
                      ...
                      echo "<td><a href='tambahcompany.php?idcompany=$user_data[idcompany]' class='btn btn-info'>Tambah City</a></td>"; 
